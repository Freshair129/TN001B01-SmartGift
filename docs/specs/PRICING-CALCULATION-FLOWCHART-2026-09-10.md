...
## 1. ผังงานภาพรวมการคำนวณ (Mermaid Flowchart)
...
flowchart TD
    ...
    subgraph STAGE1["2. สเต็ปต้นทุน (Landed Cost Engine)"]
        B1["1. แปลงทุนโรงงานเป็นบาท
ทุนโรงงานบาท = USD x อัตราแลกเปลี่ยน"]:::calc
        B2["2. ค่าขนส่งจีน-ไทยต่อชิ้น
ค่าเรือจีน-ไทย = (CBM x เรท CBM) / Qty"]:::calc
        B3["3. ค่าส่งในไทยต่อชิ้น (ท่าเรือสู่ลูกค้า)
ค่าส่งในไทยต่อชิ้น = ค่ารถเหมาเที่ยว / Qty"]:::calc
        
        B4["รวมต้นทุนส่งมอบต่อชิ้น (Total Landed Cost)
Landed Cost = ทุนโรงงานบาท + ค่าเรือจีน-ไทย + ค่าส่งในไทยต่อชิ้น"]:::calc
    end

    subgraph STAGE2["3. สเต็ปตั้งราคาขายองค์กร (Corporate Pricing)"]
        C1["คำนวณราคาขายตามบันไดส่วนลด
ราคาขายฐาน = Landed Cost x มาร์กอัป 1.47 x ตัวคูณส่วนลดตามจำนวน"]:::calc
    end

    subgraph GATE["4. ด่านตรวจกำไรขั้นต่ำ (Profit Floor Gate)"]
        D1{"กำไรรวมทั้งออเดอร์
ไม่ต่ำกว่า 3000 บาท หรือไม่?
กำไร = (ราคาขาย - Landed Cost) x Qty"}:::gate
        D2["ปรับราคาขายขึ้นเพื่อล็อกกำไรขั้นต่ำ
ราคาขายใหม่ = Landed Cost + (3000 / Qty)"]:::calc
    ...
    subgraph OUT["5. ยอดรวมในใบเสนอราคา (Quotation Total)"]
        ...
        E2["ยอดรวมสินค้าก่อนภาษี = ราคาขายต่อชิ้น x Qty
ค่าจัดส่ง = 0 บาท (รวมส่งท่าเรือถึงหน้างาน 1 จุด)"]:::output
